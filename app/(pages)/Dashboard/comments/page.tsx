                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-xl text-neutral-500 dark:text-neutral-400">
                                This is your Comments dashboard — access features here and manage your account.
                            </p>
                        </div>
                ...
                <div className="flex flex-col gap-6 md:flex-row w-full">
                    <div className="rounded-xl bg-white p-6 shadow dark:bg-neutral-900 w-full md:w-1/2">
                        ...
                        onClick={
                            ...
                            Go to Comments Display <FaArrowRight />
                        </button>
                        <button  className="flex transition items-center gap-2 underline text-blue-500 font-semibold"
                        onClick={
                            () => {
                            ...
                            Go to Comments Create <FaArrowRight />
                        </button>
                        <button  className="flex transition items-center gap-2 underline text-blue-500 font-semibold"
                        onClick={
                            () => {
                            ...
                            Go to Comments Delete <FaArrowRight />
                        </button>
                        </div>
                    </div>
                    <div className="rounded-xl bg-white p-6 shadow dark:bg-neutral-900 w-full md:w-1/2">
