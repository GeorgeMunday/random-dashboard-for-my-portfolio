        ...
        <main className="min-h-screen bg-gray-100 dark:bg-neutral-950">
            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                <div className="flex w-full flex-col gap-6 md:flex-row">
                    <div className="w-full rounded-xl bg-white p-6 shadow dark:bg-neutral-900 md:w-1/2">
                        <h2 className="text-lg font-semibold">Dashboard Navigation</h2>
                        <div className="mt-4 flex flex-col gap-4">
                            <button
                                className="flex items-center gap-2 font-semibold text-blue-500 underline transition"
                                onClick={() => {
                    ...
                    <div className="w-full rounded-xl bg-white p-6 shadow dark:bg-neutral-900 md:w-1/2">
                        <h2 className="text-lg font-semibold">Random Page Navigation</h2>

                        <div className="flex h-full items-center justify-center pb-6">
                            <button
                                type="button"
                                className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-500 text-sm font-medium text-white transition hover:bg-blue-400 text-neutral-700transition"
